      ...
      <div className="max-w-7xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-8 shadow-xl">
          <div className="mb-6">
            ...
            <p className="text-gray-600">Analysis complete - Here's what your data reveals</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200">
              ...
              <div className="text-2xl font-bold text-gray-800">125,430</div>
              <div className="text-sm text-green-600 font-medium">+12% vs previous</div>
            </div>
            ...
            <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-xl p-6 border border-green-200">
              ...
              <div className="text-2xl font-bold text-gray-800">98,240</div>
              <div className="text-sm text-green-600 font-medium">+10.7% vs previous</div>
            </div>
            ...
            <div className="bg-gradient-to-r from-orange-50 to-orange-100 rounded-xl p-6 border border-orange-200">
              ...
              <div className="text-2xl font-bold text-gray-800">$58,870</div>
              <div className="text-sm text-green-600 font-medium">+15% vs previous</div>
            </div>
            ...
            <div className="bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl p-6 border border-purple-200">
              ...
              <div className="text-sm text-green-600 font-medium">+0.4% vs previous</div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                  ...
                  <span className="text-blue-600 font-semibold">52,112 sessions</span>
                </div>
                <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                  <span className="font-medium text-gray-700">Direct Traffic</span>
                  <span className="text-blue-600 font-semibold">31,992 sessions</span>
                </div>
                <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                  <span className="font-medium text-gray-700">Paid Search</span>
                  <span className="text-blue-600 font-semibold">18,405 sessions</span>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-3">
                <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-gray-700">Traffic increased 12% with organic search leading growth</p>
                    </div>
                  </div>
                </div>
                <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-gray-700">Mobile traffic shows strong engagement improvement</p>
                    </div>
                  </div>
                </div>
                <div className="p-4 bg-orange-50 border border-orange-200 rounded-lg">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-gray-700">Paid search delivers highest conversion rate at 3.1%</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            ...
            <button
              ...
              className="px-6 py-3 bg-gradient-to-r from-gray-500 to-gray-600 text-white rounded-xl hover:from-gray-600 hover:to-gray-700 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
              Import More Data
            </button>
          </div>
